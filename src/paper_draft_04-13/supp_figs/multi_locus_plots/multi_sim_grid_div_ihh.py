...
#file paths
out_dir = '../../../../results/paper_draft_04-13/supp_figs/multi_locus_plots/'
data_dir = '../../../../data/slim_simulations/05-29-2026_sims/'
...
for ind_1, curr_num_origins in enumerate(ORIGIN_NUM_LIST):
    ...
    if curr_num_origins == 1:
        ...
        curr_ihh_ax.set_ylabel('Genetic linkage\n(standardized iHH)')
    else:
        #turn off the xticks
...
plt.savefig(out_dir + 'multi_sim_grid_div_ihh.png', dpi = 300)
plt.close()